package mendoza.misael.myfeelings

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Log
import android.widget.Toast
import mendoza.misael.myfeelings.utilities.CustomBarDrawable
import mendoza.misael.myfeelings.utilities.CustomCircleDrawable
import mendoza.misael.myfeelings.utilities.Emociones
import mendoza.misael.myfeelings.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    fun iconoMayoria(){
        ...
        if (verySad>happy && verySad>neutral && verySad>veryHappy && verySad>sad){
